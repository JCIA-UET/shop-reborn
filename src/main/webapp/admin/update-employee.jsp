...
<jsp:include page="header.jsp"></jsp:include>
	<h1 class="page-header">Update Employee's Information</h1>
	<form action="AdEmployeeService" method="post">
		...
		<div class="form-group">
			...
			<input class="form-control" type="text" name="realname" value="${employee.realName }" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input class="form-control" type="text" name="phone" value="${employee.phone }" required>
		</div>
		<div class="form-group">
			<label>Address</label>
